...
export function FileUpload() {
  ...
  async function submit(event: React.FormEvent<HTMLFormElement>) {
    ...
    setProgress(response.ok ? 100 : 0); setMessage(response.ok ? "Document uploaded and quarantined for virus scanning." : result.error ?? "Upload could not be completed."); setSending(false);
